...
* Updated Boss Room to NGO 1.2.0 (#791).
  * Removing a workaround in our tests to prevent NetworkManager from destroying the GameObject we use as a PlayerPrefab. (see PR https://github.com/Unity-Technologies/com.unity.netcode.gameobjects/pull/2275)
