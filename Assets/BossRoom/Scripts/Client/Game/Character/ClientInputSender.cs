...
namespace BossRoom.Client
{
    ...
    public class ClientInputSender : NetworkedBehaviour
    {
        ...
        [SerializeField]
        InputAction m_TargetInput;

        [SerializeField]
        InputAction m_CursorPosition;

        [SerializeField]
        InputAction m_SkillInput1;

        [SerializeField]
        InputAction m_SkillInput2;
        ...
        [SerializeField]
        InputAction m_EmoteInput1;

        [SerializeField]
        InputAction m_EmoteInput2;

        [SerializeField]
        InputAction m_EmoteInput3;

        [SerializeField]
        InputAction m_EmoteInput4;
        ...
        void OnEnable()
        {
            m_TargetInput.Enable();
            m_CursorPosition.Enable();

            m_SkillInput1.Enable();
            m_SkillInput2.Enable();

            m_EmoteInput1.Enable();
            m_EmoteInput2.Enable();
            m_EmoteInput3.Enable();
            m_EmoteInput4.Enable();
        }

        void OnDisable()
        {
            m_TargetInput.Disable();
            m_CursorPosition.Disable();

            m_SkillInput1.Disable();
            m_SkillInput2.Disable();

            m_EmoteInput1.Disable();
            m_EmoteInput2.Disable();
            m_EmoteInput3.Disable();
            m_EmoteInput4.Disable();
        }
        ...
        void PerformSkill(ActionType actionType, SkillTriggerStyle triggerStyle)
        {
            int numHits = 0;
        ...
        void QueryInputs()
        {
            if (m_SkillInput2.triggered)
            {
                if (m_SkillInput2.ReadValue<float>() > 0)
                {
