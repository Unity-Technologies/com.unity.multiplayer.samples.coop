...
namespace Unity.Multiplayer.Samples.BossRoom.Client
{
    ...
    public class ClientMainMenuState : GameStateBehaviour
    {
        ...
        async void InjectDependenciesAndInitialize(AuthenticationServiceFacade authServiceFacade, LocalLobbyUser localUser, LocalLobby localLobby)
        {
            ...
            {
                PopupManager.ShowPopupPanel("Unity Game Services ProjectID not set up" ,"Click the Readme file in the Assets Folder within the Project window in-editor to follow \"How to set up Unity Game Services\"");
                OnSignInFailed();
                return;
            }
