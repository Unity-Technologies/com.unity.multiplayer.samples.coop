...
namespace BossRoom.Visual
{
    ...
    public class UIHUDButton : Button, IPointerDownHandler, IPointerUpHandler
    {
        ...
        /// <summary>
        /// Can be set in code by the owner; this is the parameter passed to OnPointerDownEvent/OnPointerUpEvent callbacks
        /// </summary>
        public int ButtonID { get; set; }

        /// <summary>
        /// Called when the user clicks down on the button (but hasn't released the button yet)
        /// Passes in this button's ButtonID as a parameter
        /// </summary>
        public Action<int> OnPointerDownEvent;

        /// <summary>
        /// Called when the user clicks up on the button (completing a click event)
        /// Passes in this button's ButtonID as a parameter
        /// </summary>
        public Action<int> OnPointerUpEvent;
