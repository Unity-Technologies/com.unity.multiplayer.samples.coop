...
namespace Unity.Multiplayer.Samples.BossRoom.Shared.Infrastructure
{
    ...
    ///
    /// When subscribing to the channel, it will immediately invoke subscription if it already has a buffered value.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public class BufferedNetworkedMessageChannel<T> : BufferedMessageChannel<T> where T : unmanaged, INetworkSerializeByMemcpy
    {
        string m_Name;
